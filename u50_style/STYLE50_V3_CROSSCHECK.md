...
u50 (real `+/-` diff, no banner, no hints):
...
Clean file: style50 prints `Results generated by style50 v3.0.0` / `Looks good!` / `But consider adding more comments!`; u50 prints **nothing** (silent success). By-design divergence (register #6).
